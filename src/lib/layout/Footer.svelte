...
<footer class="flex-none mt-auto w-full py-10 px-4 sm:px-6 lg:px-8 mx-auto bg-slate-50 dark:bg-slate-900">
  <!-- Grid -->
  <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6 mb-10">
    <div class="col-span-full hidden lg:col-span-1 lg:block">
      <a class="flex-none text-xl font-semibold dark:text-white" href="#" aria-label="Brand">{PUBLIC_ORG_NAME}</a>
      <p class="mt-3 text-xs sm:text-sm text-gray-600 dark:text-gray-400">© 2024 {PUBLIC_ORG_NAME}</p>
    </div>
    <!-- End Col -->
