...
<div class="flex flex-col">
  <div class="-m-1.5 overflow-x-auto">
    <div class="p-1.5 min-w-full inline-block align-middle">
      <div
        class="bg-white border border-base-200 rounded-xl shadow-sm overflow-hidden dark:bg-base-900 dark:border-base-700">
        <!-- Header -->
        <div
          class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-base-200 dark:border-base-700">
          <div>
            <h2 class="text-xl font-semibold text-base-800 dark:text-base-200">Users</h2>
            <p class="text-sm text-base-600 dark:text-base-400">Add users, edit and more.</p>
          </div>

          <div>
            <div class="inline-flex gap-x-2">
              <a
                class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-base-200 bg-white text-base-800 shadow-sm hover:bg-base-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-base-900 dark:border-base-700 dark:text-white dark:hover:bg-base-800"
                href="#">
                View all
              </a>
            ...
            <tr>
              <th scope="col" class="ps-6 py-3 text-start">
                <label for="hs-at-with-checkboxes-main" class="flex">
                  <input
                    type="checkbox"
                    class="shrink-0 border-base-300 rounded text-blue-600 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-base-900 dark:border-base-600 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-base-800"
                ...
                <div class="px-6 py-3">
                  <div class="flex items-center gap-x-3">
                    ...
                    <div class="flex w-full h-1.5 bg-base-200 rounded-full overflow-hidden dark:bg-base-700">
                      <div
                        class="flex flex-col justify-center overflow-hidden bg-base-800 dark:bg-base-200"
                        role="progressbar"
                        style="width: 25%"
                        aria-valuenow="25"
                        aria-valuemin="0"
            ...
            <tr>
              ...
              <td class="size-px whitespace-nowrap">
                <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                  <div class="flex items-center gap-x-3">
                    <span
                      class="inline-flex items-center justify-center size-[38px] rounded-full bg-white border border-base-300 dark:bg-base-900 dark:border-base-700">
        ...
        <!-- Footer -->
        <div
          class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-t border-base-200 dark:border-base-700">
          <div>
          ...
          <div>
            <div class="inline-flex gap-x-2">
              <button
                type="button"
                class="py-1.5 px-2 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-base-200 bg-white text-base-800 shadow-sm hover:bg-base-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-base-900 dark:border-base-700 dark:text-white dark:hover:bg-base-800">
                <svg
                  class="flex-shrink-0 size-4"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
