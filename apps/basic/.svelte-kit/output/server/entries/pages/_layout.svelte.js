import { S as store_get, T as unsubscribe_stores, R as pop, P as push, V as head } from "../../chunks/index.js";
...
function Header($$payload, $$props) {
  ...
  var $$store_subs;
  const { session } = $$props;
  $$payload.out += `<header class="svelte-1u9z1tp"><div class="corner svelte-1u9z1tp"><a href="https://svelte.dev/docs/kit" class="svelte-1u9z1tp"><img${attr("src", logo)} alt="SvelteKit" class="svelte-1u9z1tp"></a></div> <nav class="svelte-1u9z1tp"><svg viewBox="0 0 2 3" aria-hidden="true" class="svelte-1u9z1tp"><path d="M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z" class="svelte-1u9z1tp"></path></svg> <ul class="svelte-1u9z1tp"><li${attr("aria-current", store_get($$store_subs ??= {}, "$page", page).url.pathname === "/" ? "page" : void 0)} class="svelte-1u9z1tp"><a href="/" class="svelte-1u9z1tp">Home</a></li> `;
  if (session) {
    $$payload.out += "<!--[-->";
    $$payload.out += `<li${attr("aria-current", store_get($$store_subs ??= {}, "$page", page).url.pathname.startsWith("/logout") ? "page" : void 0)} class="svelte-1u9z1tp"><a href="/logout" class="svelte-1u9z1tp">Logout</a></li>`;
  } else {
    $$payload.out += "<!--[!-->";
    $$payload.out += `<li${attr("aria-current", store_get($$store_subs ??= {}, "$page", page).url.pathname.startsWith("/register") ? "page" : void 0)} class="svelte-1u9z1tp"><a href="/register" class="svelte-1u9z1tp">Register</a></li> <li${attr("aria-current", store_get($$store_subs ??= {}, "$page", page).url.pathname.startsWith("/login") ? "page" : void 0)} class="svelte-1u9z1tp"><a href="/login" class="svelte-1u9z1tp">Login</a></li>`;
  }
  $$payload.out += `<!--]--></ul> <svg viewBox="0 0 2 3" aria-hidden="true" class="svelte-1u9z1tp"><path d="M0,0 L0,3 C0.5,3 0.5,3 1,2 L2,0 Z" class="svelte-1u9z1tp"></path></svg></nav> <div class="corner svelte-1u9z1tp"><a href="https://github.com/sveltejs/kit" class="svelte-1u9z1tp"><img${attr("src", github)} alt="GitHub" class="svelte-1u9z1tp"></a></div></header>`;
...
function _layout($$payload, $$props) {
  ...
  head($$payload, ($$payload2) => {
    $$payload2.out += `<script src="https://accounts.google.com/gsi/client" async><\/script> <script src="https://appleid.cdn-apple.com/appleauth/static/jsapi/appleid/1/en_US/appleid.auth.js" async><\/script>`;
  });
  $$payload.out += `<div class="app svelte-8o1gnw">`;
  Header($$payload, { session: data.session });
