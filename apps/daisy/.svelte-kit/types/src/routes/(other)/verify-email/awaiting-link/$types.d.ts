...
type RouteParams = {  };
type RouteId = '/(other)/verify-email/awaiting-link';
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(other)/verify-email/awaiting-link/+page.server.js').load>>>>>>;
