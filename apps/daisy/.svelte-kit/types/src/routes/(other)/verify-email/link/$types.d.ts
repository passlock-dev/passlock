...
type RouteParams = {  };
type RouteId = '/(other)/verify-email/link';
...
type ActionsExport = typeof import('../../../../../../../src/routes/(other)/verify-email/link/+page.server.js').actions
export type SubmitFunction = Kit.SubmitFunction<Expand<ActionsSuccess<ActionsExport>>, Expand<ActionsFailure<ActionsExport>>>
export type ActionData = Expand<Kit.AwaitedActions<ActionsExport>> | null;
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/(other)/verify-email/link/+page.server.js').load>>>>>>;
