...
type LayoutRouteId = RouteId | "/(other)" | "/(other)/login" | "/(other)/login/action" | "/(other)/logout/action" | "/(other)/register/action" | "/(other)/verify-email/awaiting-link" | "/(other)/verify-email/code" | "/(other)/verify-email/link"
