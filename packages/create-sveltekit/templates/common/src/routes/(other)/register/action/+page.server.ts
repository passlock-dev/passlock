...
import { todos, verifyEmailAwaitLink, verifyEmailCode } from '$lib/routes'
 ...
 * as this route has actions, it can't be pre-rendered
 */
...
export const actions = {
  default: async ({ request, cookies }) => {
    ...
    // You probably don't need this as you could simply hard code
    // the redirect. Basically we check the type of mailbox verification
    // (set in routes/(other)/+page.svelte) and redirect accordingly
