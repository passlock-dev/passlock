...
<button use:melt={$trigger} class="flex size-8 items-center justify-center rounded-full bg-gray-100">
  <img
    use:melt={$image}
...
<form bind:this={form} method="post" action={logoutAction} class="hidden"></form>
