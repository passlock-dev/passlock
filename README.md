...
> [!IMPORTANT]  
> **Looking for the SvelteKit templates?** Use the [@passlock/create-sveltekit](./packages/create-sveltekit/docs/README.md) CLI to create a new project with Passkey authentication, social login and more..
