---
name: proofread-server-docs
description: Proofread the @passlock/server TypeDoc/JSDoc. Use whenever you are asked to proofread the @passlock/server documentation.
metadata:
